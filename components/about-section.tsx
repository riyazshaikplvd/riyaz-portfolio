...
export function AboutSection() {
  return (
    <section
      id="about"
      className="py-24 px-4 sm:px-6 lg:px-8 min-h-screen flex items-center bg-slate-950"
    >
      <div className="mx-auto max-w-5xl w-full text-center">
        ...
        <div className="text-slate-300 text-lg leading-relaxed space-y-6">
          ...
          <p>
            ...
            <span className="text-cyan-400 font-medium underline decoration-cyan-400/30 underline-offset-4">Windows Event Logs</span>,{" "}
            <span className="text-cyan-400 font-medium underline decoration-cyan-400/30 underline-offset-4">Linux syslogs</span>, and network
            traffic to identify and respond to security incidents using tools such as{" "}
            <span className="text-cyan-300 font-bold italic underline underline-offset-2 decoration-cyan-300/50">Splunk</span>,{" "}
            <span className="text-cyan-300 font-bold italic underline underline-offset-2 decoration-cyan-300/50">Wazuh</span>,{" "}
            <span className="text-cyan-300 font-bold italic underline underline-offset-2 decoration-cyan-300/50">IBM QRadar</span>, and{" "}
            <span className="text-cyan-300 font-bold italic underline underline-offset-2 decoration-cyan-300/50">Microsoft Sentinel</span>.
          </p>
          ...
          <p>
            ...
            <span className="text-cyan-400 font-semibold bg-cyan-400/10 px-1">MITRE ATT&CK framework mapping</span>,
            with a focus on improving detection accuracy and reducing false positives.
          </p>

          <p className="border-t border-slate-800 pt-6">
            Strong understanding of <span className="text-white font-semibold">SOC workflows</span> including monitoring, investigation,
