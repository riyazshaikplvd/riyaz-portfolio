...
export function AboutSection() {
  return (
    <section
      id="about"
    className="min-h-[calc(100vh-80px)] pt-20 px-4 sm:px-6 lg:px-8 scroll-mt-32 bg-slate-950"
    >
      <div className="mx-auto max-w-5xl w-full text-center">
        ...
        <div className="text-slate-300 text-lg leading-relaxed space-y-6">
          ...
          <p className="border-t border-slate-800 pt-6">
            ...
            including monitoring, investigation, escalation, and reporting.
            Passionate about protecting digital assets, continuously improving
            security posture, and contributing effectively to modern SOC teams.
          </p>
