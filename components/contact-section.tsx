      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto text-lg font-medium">
            I&apos;m actively seeking <span className="text-cyan-400 font-bold">SOC Analyst</span> opportunities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-3xl mx-auto mb-12">
          ...
          <a
            ...
            className="group relative overflow-hidden bg-gradient-to-br from-cyan-500/20 to-cyan-600/20 border-2 border-cyan-500/50 rounded-xl p-5 text-center hover:border-cyan-400 hover:shadow-[0_0_30px_rgba(34,211,238,0.4)] transition-all duration-300 hover:scale-105"
          >
          ...
          <a
            ...
            className="group relative overflow-hidden bg-gradient-to-br from-emerald-500/20 to-green-600/20 border-2 border-emerald-500/50 rounded-xl p-5 text-center hover:border-emerald-400 hover:shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all duration-300 hover:scale-105"
          >
            <div className="flex justify-center mb-3">
